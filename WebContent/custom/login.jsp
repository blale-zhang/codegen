...
<title>${title}</title>
<link rel="stylesheet" href="newlogin.css" type="text/css" />
      ...
      <div class="mbg">
        <div class="login">
          ...
          <div class="form">
            ...
            <form id="loginForm" method="post" action="${ctx}/login/login.do"">
              ...
              <div class="user"> <span class="text">验证码：</span>
                <input type="text" class="input1" id="str_checkcode" tabindex="1" name="str_checkcode" />
                <input type="hidden" name="needvcode" value="1" />
                <span class="img">
                <img src="images/CheckImage.gif"/>
              ...
              <div class="user2">
                <input id="btnSubmit" tabindex="1" type="submit" name="Submit1" value="登录" class="submit" />
