...
<body>
	...
	<input id="usrOrRole" type="hidden" value="${usrOrRole}"/>
	
</body>
<script src="${ctx}/custom/js/authority-mgr.js" type="text/javascript"></script>
<script src="${ctx}/custom/js/authority.js" type="text/javascript"></script>
<script type="text/javascript">
	// 	seajs.use([ '../custom/js/user-list' ]);//这句会把js引入
	seajs.use([ 'authority-mgr' ]);
</script>
</html>