...
<link href="${ctx}/MetroNic_2.0.2-bootstrap3.1.1/assets/plugins/font-awesome/css/font-awesome.min.css" tppabs="http://www.keenthemes.com/preview/metronic_admin/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
...
<link rel="stylesheet" type="text/css" href="${ctx}/component/MetroNic_2.0.2-bootstrap3.1.1/assets/plugins/select2/select2.css" tppabs="http://www.keenthemes.com/preview/metronic_admin/assets/plugins/select2/select2.css"/>
<link rel="stylesheet" type="text/css" href="${ctx}/component/MetroNic_2.0.2-bootstrap3.1.1/assets/plugins/select2/select2-metronic.css" tppabs="http://www.keenthemes.com/preview/metronic_admin/assets/plugins/select2/select2-metronic.css"/>
...
<link href="${ctx}/component/MetroNic_2.0.2-bootstrap3.1.1/assets/css/pages/login.css" tppabs="http://www.keenthemes.com/preview/metronic_admin/assets/css/pages/login.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html" tppabs="http://www.keenthemes.com/preview/metronic_admin/index.html">
		<img src="${ctx}/component/MetroNic_2.0.2-bootstrap3.1.1/assets/img/logo-big.png" tppabs="http://www.keenthemes.com/preview/metronic_admin/assets/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="${ctx}/login/login.do" method="post">
